...
1. Abra el panel Comprobaciones en el contexto de la página que desea auditar y ejecute las auditorías.
1. Seleccione una oportunidad específica en la lista del panel Comprobaciones.
1. La previsualización se desplaza automáticamente al área relevante y resalta el elemento correspondiente, lo que le permite identificar fácilmente y optimizar la oportunidad en contexto.
